...
export function Logo({ onClick }) {
  return (
    <div className="flex items-center justify-center mt-2">
      <MotionLink
        href="/"
        className="w-40 h-12 bg-dark text-light flex justify-center 
        items-center rounded-md text-xl font-bold border border-solid border-transparent dark:border-light"
        whileHover={{
          backgroundColor: [
            "#121212",
            "rgba(131,58,180,1)",
...
export const GmailIcon = ({ className, ...rest }) => (
  ...
  >
    ...
    <path fill="#b8b7ae" d="m148.96 931.095 494.873-344.324-2.24-1.586L148.96 923.527z" />
